...
<div class="panel panel-body">
  Pour créer un formulaire, vous devez cliquer sur n'importe quel type de question dans la section présentation (barre latérale droite) ci-dessous. Veuillez vous assurer de remplir le champ approprié avant de soumettre.
</div>
            ...
            <div class="sidebar-category">
                ...
                <div class="category-content no-padding">
                    <ul class="navigation navigation-alt navigation-accordion" data-form="{{ $form->code }}">
                        <li class="navigation-header">Sélectionner le type de question</li>
                        <li><a href="javascript:void()" class="question-template" data-id="short-answer"><i class="icon-minus3"></i> Réponses courtes</a></li>
                        <li><a href="javascript:void()" class="question-template" data-id="long-answer"><i class="icon-menu7"></i> Réponses longues</a></li>
                        <li class="navigation-divider"></li>
                        <li><a href="javascript:void()" class="question-template" data-id="multiple-choices"><i class="icon-radio-checked"></i> choix multiple</a></li>
