...
<ul class="dropdown-menu dropdown-menu-right">
    ...
    @if (in_array($form->status, [$form::STATUS_OPEN, $form::STATUS_CLOSED]))
        ...
        @if ($form->responses()->has('fieldResponses')->exists())
            <li><a id="delete-button" data-href="{{ route('forms.responses.destroy.all', $form->code) }}" data-message="Êtes-vous sur de vouloir supprimer toutes les réponses concernants ce formulaire?">Delete all Responses</a></li>
